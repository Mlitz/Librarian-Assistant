...
class TokenDialog(QDialog):
    ...
    def findChild(self, child_type, child_name):
        ...
        if child_type == QPushButton:
            if child_name == "okButton" and self.button_box.button(QDialogButtonBox.StandardButton.Ok):
                return self.button_box.button(QDialogButtonBox.StandardButton.Ok)
            if child_name == "cancelButton" and self.button_box.button(QDialogButtonBox.StandardButton.Cancel):
