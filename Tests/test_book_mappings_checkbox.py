...
from PyQt6.QtWidgets import QApplication, QCheckBox, QLabel, QGroupBox
...
class TestBookMappingsCheckbox(unittest.TestCase):
    ...
    def test_select_all_functionality(self):
        ...
        # Call the toggle method directly instead of emitting signal
        self.window.editions_table_widget._toggle_all_checkboxes()

        # Process events again after toggle
        QApplication.processEvents()
