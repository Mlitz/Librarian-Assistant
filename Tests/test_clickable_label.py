...
class TestClickableLabel(unittest.TestCase):
    ...
    def test_initial_state(self):
        ...
        self.assertEqual(self.label.textFormat(), Qt.TextFormat.RichText)
        self.assertFalse(self.label.openExternalLinks())
        self.assertEqual(self.label.cursor().shape(), Qt.CursorShape.ArrowCursor)
    ...
    def test_set_content_with_valid_url(self):
        ...
        self.assertEqual(self.label.cursor().shape(), Qt.CursorShape.PointingHandCursor)
